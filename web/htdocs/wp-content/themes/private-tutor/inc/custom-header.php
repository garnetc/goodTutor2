...
function private_tutor_header_style() {
	...
	$private_tutor_show_site_tagline_color = esc_attr(get_theme_mod('private_tutor_show_site_tagline_color','#452892'));
	?>
	...
	<style type="text/css">
		...
		p.site-description {
			color: <?php echo apply_filters('private_tutor_header', $private_tutor_show_site_tagline_color); ?>;
		}
