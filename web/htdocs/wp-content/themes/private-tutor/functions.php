...
if ( ! function_exists( 'private_tutor_credit' ) ) {
	function private_tutor_credit(){
		echo "<a href=".esc_url(PRIVATE_TUTOR_CREDIT)." target='_blank'>".esc_html__(get_theme_mod('private_tutor_footer_copy',__('Private Tutor WordPress Theme By Luzuk','private-tutor')))."</a>";
	}
}
