...
<div id="blog-box" class="ht-blog-wrap innerpage-whitebox col-md-9 ">
          <?php
                ...
                $(function(){
                  function innerblogpostHeight(){
                    var ht = 0;
                    $('.page-template-blog-right-sidebar .inner-blogpost-info').each(function(i){
                      var tHt = $(this).height();
                      if(ht<tHt){
                        ht=tHt;
                      }
                    });
                    $('.page-template-blog-right-sidebar .inner-blogpost-info').height(ht+'px');
                  }
                  innerblogpostHeight();
                });
